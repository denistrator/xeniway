...
import { ApplicationWorkspaceHeader } from "./application-workspace-header";
import { ApplicationWorkspaceSidebar } from "./application-workspace-sidebar";
import { ContactsSection } from "./contacts-section";
import { FollowUpsSection } from "./follow-ups-section";
import { PreparationSection } from "./preparation-section";
import { useWorkspaceActions } from "./use-workspace-actions";
import { parseApplicationId } from "./workspace-board";
